...
function [direct_operating_cost] = direct(AF, MTOW, tb, CEF_1989, CEF_1999, R, C_airframe, C_aircraft, C_engines, SHP_to)
    
    K = 2.75; % using regional route factor

    n_engines = 6; % engine number = ~6
    ...
    W_b = 4093; % lbs
    P_elec = 1000; % kW
    e_elec = 400 / W_b; % kW/hr / weight of battery
